...
- (void)setupNetworkServiceType:(NSURLRequestNetworkServiceType)requestNetworkServiceType
{
    ...
    switch (requestNetworkServiceType) {
        ...
        case NSURLNetworkServiceTypeCallSignaling:
            ...
            break;
#endif
#if (__MAC_OS_X_VERSION_MAX_ALLOWED >= 101400 || __IPHONE_OS_VERSION_MAX_ALLOWED >= 120000 || __TV_OS_VERSION_MAX_ALLOWED >= 120000 || __WATCH_OS_VERSION_MAX_ALLOWED >= 50000)
        case NSURLNetworkServiceTypeResponsiveData:
            networkServiceType = NSStreamNetworkServiceTypeVoice; // XXX
            break;
#endif
    }
